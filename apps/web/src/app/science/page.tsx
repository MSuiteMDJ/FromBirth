    ...
    <div className="min-h-screen">
      <section className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
        <div className="mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-widest uppercase mb-3 md:mb-4">The Science</h1>
        ...
        <article className="space-y-4 md:space-y-6">
          <div>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold tracking-widest uppercase mt-6 md:mt-8 mb-2 md:mb-3">Mesenchymal Stem Cells (MSC)</h2>
          ...
          <div>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold tracking-widest uppercase mt-6 md:mt-8 mb-2 md:mb-3">Exosome Technology</h2>
            <p className="text-sm md:text-base leading-relaxed">
          ...
          <div>
            <h2 className="text-xl md:text-2xl lg:text-3xl font-bold tracking-widest uppercase mt-6 md:mt-8 mb-2 md:mb-3">Clinical Safety</h2>
            <p className="text-sm md:text-base leading-relaxed">
          ...
          <div className="bg-fb-off-white border-l-4 border-fb-lilac p-3 md:p-4 lg:p-6 mt-6 md:mt-8 rounded-r">
            <p className="text-[12px] md:text-sm text-fb-text leading-relaxed">
