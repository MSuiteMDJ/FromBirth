    ...
    <div className="min-h-screen">
      <section className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8">
        <div className="mb-6 md:mb-8">
          <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl mb-3 md:mb-4">The Craft</h1>
        ...
        <article className="prose prose-sm md:prose-base lg:prose-lg max-w-none space-y-4 md:space-y-6">
          <div>
            <h2 className="font-serif text-xl md:text-2xl lg:text-3xl mt-6 md:mt-8 mb-2 md:mb-3">Ingredient Sourcing</h2>
          ...
          <div>
            <h2 className="font-serif text-xl md:text-2xl lg:text-3xl mt-6 md:mt-8 mb-2 md:mb-3">Formulation Philosophy</h2>
            <p className="text-sm md:text-base leading-relaxed">
          ...
          <div>
            <h2 className="font-serif text-xl md:text-2xl lg:text-3xl mt-6 md:mt-8 mb-2 md:mb-3">Packaging</h2>
            <p className="text-sm md:text-base leading-relaxed">
          ...
          <div>
            <h2 className="font-serif text-xl md:text-2xl lg:text-3xl mt-6 md:mt-8 mb-2 md:mb-3">Quality Assurance</h2>
            <p className="text-sm md:text-base leading-relaxed">
